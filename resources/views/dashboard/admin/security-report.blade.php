...
@section('sidebar-nav')
    ...
    <a href="{{ route('admin.security-report') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg bg-orange-500 text-white text-sm font-medium">
        <i data-lucide="shield" class="w-5 h-5"></i> Security Report
    </a>
@endsection
