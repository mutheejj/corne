...
class RegistrationApprovedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Candidate Registration Approved — Cornelect')
            ->line('Congratulations! Your candidate registration has been approved.')
            ->line('You can now manage your campaign profile and interact with voters.')
            ->action('View Dashboard', url('/candidate'))
